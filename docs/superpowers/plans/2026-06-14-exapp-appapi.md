...
NEXTCLOUD_URL=https://deine-nextcloud.example.com NEXTCLOUD_USER=dein-nutzername NEXTCLOUD_APP_PASSWORD=xxx \
...
php occ app_api:daemon:register \
  ...
  http <doday-container-host>:9000 https://deine-nextcloud.example.com
```
...
- "traefik.http.middlewares.doday-redir.redirectregex.replacement=https://deine-nextcloud.example.com/index.php/apps/app_api/proxy/doday/"
